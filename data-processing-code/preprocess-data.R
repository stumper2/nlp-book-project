...
# Combine
it_1200 = data.frame(Italian_1200, era = "1200")
it_1400 = data.frame(Italian_1400, era = "1400")
it_1550 = data.frame(Italian_1550, era = "1550")
it_1700 = data.frame(Italian_1700, era = "1700")
it_1815 = data.frame(Italian_1815, era = "1815")
it_1915 = data.frame(Italian_1915, era = "1915")
Italian = rbind(it_1200, it_1400, it_1550, it_1700, it_1815, it_1915)
# saveRDS(Italian, "../data/italian.rds")

es_1400 = data.frame(Spanish_1400, era = "1400")
es_1600 = data.frame(Spanish_1600, era = "1600")
es_1700 = data.frame(Spanish_1700, era = "1700")
es_1800 = data.frame(Spanish_1800, era = "1800")
es_1850 = data.frame(Spanish_1850, era = "1850")
es_1900 = data.frame(Spanish_1900, era = "1900")
Spanish = rbind(es_1400, es_1600, es_1700, es_1800, es_1850, es_1900)
# saveRDS(Spanish, "../data/spanish.rds")

en_1066 = data.frame(English_1066, era = "1066")
en_1500 = data.frame(English_1500, era = "1500")
en_1660 = data.frame(English_1660, era = "1660")
en_1785 = data.frame(English_1785, era = "1785")
en_1832 = data.frame(English_1832, era = "1832")
en_1901 = data.frame(English_1901, era = "1901")
en_1914 = data.frame(English_1914, era = "1901")
English = rbind(en_1066, en_1500, en_1660, en_1785, en_1832, en_1901, en_1914)
# saveRDS(English, "../data/english.rds")